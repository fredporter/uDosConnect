...
> **Archive:** Historical narrative. This file lived at the **uDosConnect** repository root; it was moved to `uDosDev/docs/archive/` when the repo was prepared for public publishing. Paths below still describe the older **`uDOS-family`** / **`uDOS-v3.code-workspace`** layout. **Current** family planning uses **`~/Code/uDosGo/`** (integration) and **`~/Code/uDosConnect/…`** (everything else) — see [`../../../docs/family-workspace-layout.md`](../../../docs/family-workspace-layout.md).
...
workspace. **Numbered v2 workspace files are archived under `uDOS-dev/workspaces/archive/v2/`** (see **`uDOS-dev/workspaces/README.md`**). Current work uses **`uDOS-v3.code-workspace`** at the family root.
...
- **Cursor numbered lanes:** **Workspaces 01–09** **closed** **2026-04-02** (09 optional post-08). **Workspace 08:** `uDOS-dev/workspaces/archive/v2/cursor-08-family-convergence.code-workspace`; round `cursor-08-family-convergence-2026-04-01.md` **CLOSED**; exit evidence `uDOS-dev/docs/workspace-08-exit-evidence.md`. **Workspace 09:** `uDOS-dev/workspaces/archive/v2/cursor-09-classic-modern-mvp.code-workspace`; round `cursor-09-classic-modern-mvp-2026-04-02.md` **CLOSED**; canonical pack `uDOS-docs/docs/classic-modern-mvp-0.1/README.md`.
...
- Optional: open `uDOS-dev/workspaces/archive/v2/uDOS-v2-public.code-workspace` for orientation only; numbered
...
1. `uDOS-dev/workspaces/archive/v2/cursor-01-runtime-spine.code-workspace`
   ...
   critical uptime.
2. `uDOS-dev/workspaces/archive/v2/cursor-02-foundation-distribution.code-workspace`
...
3. `uDOS-dev/workspaces/archive/v2/cursor-03-uhome-stream.code-workspace`
   Move `uHOME` into its own delayed stream after the runtime spine and distro
   foundations are stable.
4. `uDOS-dev/workspaces/archive/v2/cursor-04-groovebox-product.code-workspace`
...
5. `uDOS-dev/workspaces/archive/v2/cursor-05-gui-system.code-workspace`
   Standardize the GUI lane around ThinUI, browser GUI surfaces, shared Svelte
   components, and Typo-driven editing/prose views.
6. `uDOS-dev/workspaces/archive/v2/cursor-06-themes-display-modes.code-workspace`
...
7. `uDOS-dev/workspaces/archive/v2/cursor-07-docs-wiki-courses.code-workspace`
   Consolidate docs, wiki, GitHub Pages style publishing, local web-hosted docs,
   and educational course hooks.
8. `uDOS-dev/workspaces/archive/v2/cursor-08-family-convergence.code-workspace`
   Review leftovers, remove duplication, unify architecture, and prepare the
   final release structure across the family.
9. `uDOS-dev/workspaces/archive/v2/cursor-09-classic-modern-mvp.code-workspace` (optional post-08 — Classic Modern / Sonic TUI; see `uDOS-dev/docs/cursor-focused-workspaces.md` § Workspace 09).
