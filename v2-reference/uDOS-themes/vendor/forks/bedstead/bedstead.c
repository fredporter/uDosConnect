...
#define FULLNAME_MAX 100
	...
	sprintf(fullname, "Teletext50%s%s", weight->suffix, width->suffix);
	return fullname;
}
...
main(int argc, char **argv)
{
	...
	printf("FullName: %s\n", get_fullname());
	printf("FamilyName: Teletext50\n");
	printf("LangName: 1033 \"\" \"Teletext50%s%s\" \"%s\" \"\" \"\" \"\" "
	       "\"\" \"\" \"\" \"\" \"\" \"\" \"\" \"\" \"\" \"\" "
	...
	printf("Copyright: Dedicated to the public domain. "
		   "This version generated by Alan Davies https://galax.xyz . "
		   "Source can be found at https://github.com/glxxyz/bedstead . "
		   "This blocky font is merely a small tweak of the awesome project that is Bedstead: https://bjh21.me.uk/bedstead \n");
	...
	// This line caused an error message when opening up these fonts in FontForge:
...
glyph_complement()
{
	...
	printf("%%!PS-Adobe\n");
	printf("%%%%Creator: Teletext50\n");
	printf("%%%%Title: Teletext50 Glyph Complement\n");
	printf("%%%%LanguageLevel: 2\n");
	printf("/xfont /Teletext50 findfont 20 scalefont def\n");
	printf("/nfont /Teletext50 findfont 10 scalefont def\n");
