...
<html lang="en">
  ...
  <body>
    <main>
      ...
      <p>Use <code>~/.udos/venv/surface/bin/udos-surface-demo</code>, <code>~/.udos/venv/surface/bin/udos-wizard-demo</code>, or <code>~/.udos/venv/surface/bin/python -m wizard.demo</code> to launch the local Surface compatibility stack, then open any lane from this page.</p>
