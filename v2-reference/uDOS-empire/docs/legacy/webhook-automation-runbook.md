# uDOS-empire Webhook Automation Runbook
...
- `uDOS-empire` sync-package export
- `uDOS-empire` automation-job queue handoff
- `uDOS-empire` automation-result recording for local end-to-end probes
- `uDOS-empire` process-next and result-fetch runtime probes against `uHOME-server`
