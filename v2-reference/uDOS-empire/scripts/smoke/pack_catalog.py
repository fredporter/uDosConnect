#!/usr/bin/env python3
"""Render the current uDOS-empire pack catalog."""
...
from udos_empire.packs import build_pack_catalog, default_artifact_path, write_pack_catalog_artifact


def main() -> int:
    parser = argparse.ArgumentParser(description="Render the uDOS-empire pack catalog")
