...
class SmokeScaffoldTests(unittest.TestCase):
    ...
    def test_sync_plan_json_runs(self) -> None:
        ...
        self.assertTrue(payload["sync_record_example_source"].endswith("uDOS-empire/examples/basic-sync-record-envelope.json"))
    ...
    def test_sync_plan_local_host_app_handoff_runs(self) -> None:
        proc = subprocess.run(
            [
                sys.executable,
                str(REPO_ROOT / "scripts" / "smoke" / "sync_plan.py"),
    ...
    def test_sync_plan_local_host_automation_handoff_runs(self) -> None:
        proc = subprocess.run(
            [
                sys.executable,
                str(REPO_ROOT / "scripts" / "smoke" / "sync_plan.py"),
    ...
    def test_sync_plan_local_host_automation_cycle_runs(self) -> None:
        proc = subprocess.run(
            [
                sys.executable,
                str(REPO_ROOT / "scripts" / "smoke" / "sync_plan.py"),
    ...
    def test_sync_plan_local_host_automation_runtime_runs(self) -> None:
        proc = subprocess.run(
            [
                sys.executable,
                str(REPO_ROOT / "scripts" / "smoke" / "sync_plan.py"),
