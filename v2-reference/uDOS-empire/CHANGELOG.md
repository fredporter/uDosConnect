...
All notable changes to `uDOS-empire` should be documented in this file.
...
- added local and HTTP handoff paths from exported sync packages into the Ubuntu host ingest route
