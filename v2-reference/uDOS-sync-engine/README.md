...
>
> **Scheduled extension track:** **4.1.13** (uDos **4.1.0** line; numbers may be reprioritized in [`uDosDev/TASKS.md`](../uDosDev/TASKS.md)).
>
...
This directory was reserved for sync-engine exploration; no runtime is bundled here.
